...
temporary filesystems, and a `${CHROME_PIDS_LIMIT:-512}` task limit (processes
and threads). This is conservative initial browser headroom, not load-proven
sizing. The app also drops all capabilities,
