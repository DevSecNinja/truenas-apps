...
2. Create a `svc-app-adguard` group (GID 3101) and user (UID 3101) on the TrueNAS host — see [Infrastructure](../../docs/INFRASTRUCTURE.md#app-service-accounts) for the full procedure
