...
| Benefit | Description |
|---------|-------------|
| **GitOps without Kubernetes complexity** | Git-driven, automated deployments without the operational overhead of running a Kubernetes cluster — compose definitions stay in git, not buried in the TrueNAS UI |
