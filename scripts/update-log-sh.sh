...
LOG_SH_URL="https://github.com/DevSecNinja/dotfiles/releases/download/v0.3.1/log.sh"
LOG_SH_SHA_URL="https://github.com/DevSecNinja/dotfiles/releases/download/v0.3.1/log.sh.sha256"
